...
function OwlLib:initBtnEffect(btn)
...
function OwlLib:newBtn(title, callback, noToggle)
...
function OwlLib:newSlider(title, callback, min, max, startPoint)
	self:Resize(self.bodyFrame);
...
function OwlLib:newTextbox(title, callback, presetText, noCallbackOnStart)
	self:Resize(self.bodyFrame);
...
function OwlLib:newBind(title, callback, presetKeyCode)
	self:Resize(self.bodyFrame);
...
function OwlLib:newCBind(title, callback, presetKeyCode)
	self:Resize(self.bodyFrame);
...
function OwlLib:newColorPicker(title, callback, presetColor)
	self:Resize(self.bodyFrame);
...
function OwlLib:newDropdown(title, callback, list, noCallbackOnStart)
	self:Resize(self.bodyFrame);
